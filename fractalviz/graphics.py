...
# Version 4.2-carleton.1 4/13/2014  [Bugfixes by Jadrian Miles]
#     * Fixed drawing offset bug (3 pixels left and 4 pixels up) due to
#       omission in GraphWin.__init__() (Originally fixed in 2.1 by
#       Laura Effinger-Dean)
#     * Added multi-button mouse support in new method getMouseWithButton()
#       (Originally implemented in 2.1 by Andy Exley)
...
class GraphWin(tk.Canvas):
    ...
    def __init__(self, title="Graphics Window",
        ...
        tk.Canvas.__init__(self, master, width=width, height=height,
                           highlightthickness=0)  # Added in 4.2-carleton.1: Fix for pixel offset bug.
        ...
        # Added in 4.2-carleton.1: multi-button support.
        self.mouseNum = None
        self.bind("<Button-2>", self._onClick)
        self.bind("<Button-3>", self._onClick)
        # End multi-button features.
        self.height = height
        self.width = width
    ...
    # Added in 4.2-carleton.1: alternate getMouse() to return button ID too.
    ...
    def _onClick(self, e):
        self.mouseX = e.x
        self.mouseY = e.y
        self.mouseNum = e.num  # Added in 4.2-carleton.1: multi-button support.
